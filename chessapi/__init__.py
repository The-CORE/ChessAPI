...
from .exceptions import IncorrectPlayerColourError, NoPieceAtPositionError, \
    PlayerNotInGameError, NotPlayersTurnError
...
def _tuple_to_discrete_vector(value):
    """
...
class Game:
    ...
    def peice_at_position(self, position):
        position = _tuple_to_discrete_vector(position)
    ...
    def move(self, position_to_move_from, position_to_move_to, player):
        position_to_move_from = _tuple_to_discrete_vector(position_to_move_from)
        position_to_move_to = _tuple_to_discrete_vector(position_to_move_to)
        if (
...
class Piece:
    ...
    def can_make_move(self, move):
        ...
        move = _tuple_to_discrete_vector(move)
